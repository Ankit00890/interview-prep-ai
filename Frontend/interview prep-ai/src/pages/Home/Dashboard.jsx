...
import DeleteAlertContent from '../../components/loder/DeleteAlertContent'
  ...
  return (
    <DashboardLayout>
      <div className="container mx-auto pt-4 pb-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-7 pt-1 pb-6 md:px-0">
