            ...
            <div className="text-[14px] prose prose-slate dark:prose-invert max-w-none">
                <ReactMarkDown
                    ...
                    components={{
                        ...
                        p({ children }) {
                            return <p className="mb-4 leading-5">
                                {children}
                            </p>
                        },
                        strong({ children }) {
                        ...
                        h4({ children }) {
                            return <h4 className="text-2xl font-bold mt-6 mb-4">{children}</h4>
                        },
                        a({ children }) {
                ...
                >
                    {copied ? (
                        <>
                            ...
                            <span className="absolute -top-8 right-0 bg-black text-white text-xs rounded-md px-2 py-1 opacity-80 transition-opacity">
                                Copied!
                            </span>
                        </>
                    ) : (
