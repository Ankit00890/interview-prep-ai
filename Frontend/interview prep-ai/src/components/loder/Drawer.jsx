...
const Drawer = ({
    ...
    return (
        <div
            className={`fixed top-[64px] right-0 z-40 h-[calc(100dvh-64px)] p-4 overflow-y-auto transition-transform bg-white w-full md:w-[40vw] shadow-2xl shadow-cyan-800/10 border-l border-l-gray-200 ${isOpen ? "translate-x-0" : "translate-x-full"
                }`}
            tabIndex="-1"
