...
const ProfilePicPhotoSelector = ({ image, setImage,preview,setPreview })=> {
...
const onChoooseFile =()=>{
    ...
    return (
        <div className="flex justify-center mb-6">
          ...
          <button
            type="button"
           className="w-8 h-8 flex items-center justify-center bg-orange-500 text-white rounded-full absolute 
...
export default ProfilePicPhotoSelector